...
urlpatterns = [
    ...
    path('rating/edit/', slot_views.sportRatingEdit, name='sport-rating-edit'),
    path('rating/delete/', slot_views.sportRatingDelete, name='sport-rating-delete'),
    ...
    path('arena/<int:arena_id>/slot/<int:slot_id>/cancel/all/', slot_views.slotCancelAll, name='slot-cancel-all'),
]
