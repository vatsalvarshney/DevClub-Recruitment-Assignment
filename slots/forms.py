...
class SlotCreationFormNoRepeat(forms.ModelForm):
    start_time = forms.SplitDateTimeField(widget=admin_widgets.AdminSplitDateTime(attrs={'style':'max-width: 15em'}))
    end_time = forms.SplitDateTimeField(widget=admin_widgets.AdminSplitDateTime(attrs={'style':'max-width: 15em'}))
    class Meta:
        model = Slot
        fields = '__all__'
